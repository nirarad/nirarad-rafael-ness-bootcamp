...
def test_user_can_cancel_order_on_status_2():
    ...
    assert ServiceSimulator.explicit_status_id_validation(status_id=AWAITING_VALIDATION_STATUS, timeout=300)
    # Run step 3
    assert cancel_api_request_scenario()
...
def test_user_can_not_cancel_order_on_status_4():
    ...
    assert ServiceSimulator.explicit_status_id_validation(status_id=PAID_STATUS, timeout=100)
...
def test_user_can_not_cancel_order_on_status_5():
    ...
    assert ServiceSimulator.explicit_status_id_validation(status_id=SHIPPED_STATUS, timeout=100)
...
def test_user_can_not_ship_order_on_status_3():
    ...
    # Run step 4
    assert ServiceSimulator.explicit_status_id_validation(status_id=STOCK_CONFIRMED_STATUS, timeout=100)
...
def test_user_can_not_ship_order_on_status_6():
    ...
    # Run step 3
    assert ship_api_request_scenario(400)
    assert ServiceSimulator.explicit_status_id_validation(status_id=CANCELED_STATUS, timeout=50)
